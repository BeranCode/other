body {background: url("https://www.newhdwallpapers.in/wp-content/uploads/2012/12/Ice-and-Cool-Beach-wide.jpg") fixed;background-repeat: no-repeat;background-size: cover;color: #000;}
...
background: rgba(147, 172, 167, 0.21);
color: #000;
...
content: url('https://i.imgur.com/FzqijO1.png')
